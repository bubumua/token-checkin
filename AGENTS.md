...
- `npx wrangler secret put SESSION_COOKIE_DKJSIOGU`: set a required secret (repeat for other targets: DUCKCODING, LINUXDOAPI, HOTARUAPI, EXTRA_COOKIE_HOTARUAPI, ZHANSI, ZZHDSGSSS, STEPHECURRY, CHENGMO, EXTRA_COOKIE_CHENGMO, NIH).
